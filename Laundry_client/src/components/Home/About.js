	...
	return (
		...
		<Container>
			<div className="d-flex justify-content-center mb-4">
				<h2 className="text-info head-title mt-5">About Us</h2>
			</div>
			<Row>
				...
				<Col md={6}>
					<p className="text-justify mb-5">
						IIITL Laundry Services is the first Online Laundry Platform in IIIT Lucknow with the latest technology in washing,
