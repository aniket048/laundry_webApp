			...
			<Container>
				<Row className="py-4">
					<Col md={6} className="py-5">
						<h2>
							Best <span className="text-info"> Wash & Iron service </span> <br /> in your doorstep
						</h2>
						<p className="text-justify my-3">
							IIITL Laundry Services is the first Online Laundry Platform in IIITL with the latest technology in
