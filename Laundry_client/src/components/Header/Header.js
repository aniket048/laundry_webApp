					...
					<Link to="/">
						<NavbarBrand onClick={(e) => e.preventDefault()}>
							<div className="row align-items-center">
								<img src={Logo} alt="IIITL Laundry Services" /> <span className="lead mx-1">IIITL Laundry Services</span>
							</div>
						</NavbarBrand>
					</Link>
					<button className="navbar-toggler" id="navbar-success" type="button">
