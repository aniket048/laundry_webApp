			...
			<Container>
				<div className="row justify-content-between py-3">
					<div className="col-md-8">
						<h2 className="text-info">Dry Cleaning Service</h2>
					</div>
					<div className="col-md-4">
						...
						<UncontrolledDropdown className="btn-group">
							...
							<DropdownMenu >
								<Link to="/wash-and-iron" className="text-info">
									<DropdownItem>Wash & Iron</DropdownItem>
								</Link>
								<Link to="/wash-and-fold" className="text-info">
									<DropdownItem>Wash & Fold</DropdownItem>
								</Link>
								<Link to="/iron-and-fold" className="text-info">
									<DropdownItem>Iron & Fold</DropdownItem>
								</Link>
								<Link to="/emergency-service" className="text-info">
									<DropdownItem>Emergency Service</DropdownItem>
								</Link>
								<Link to="/subscription-based" className="text-info">
											...
											<div key={item.id}>
												...
												<ListItem>
													<Typography className={classes.secondaryHeading}>
														<span className="price"><FontAwesomeIcon icon={faRupeeSign} /> {item.price}</span> / piece
													</Typography>
