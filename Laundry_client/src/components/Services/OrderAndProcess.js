...
const OrderAndProcess = () => {
	return (
		<Container>
			<Row className="my-2">
				<Col md={6}>
					<h2 className="text-info head-title mt-5">How to order</h2>
					...
					<div>
						<h2 className="text-info head-title mt-3">Terms & Condition</h2>
				...
				<Col md={6} className="mobileView">
					<h2 className="text-info head-title mt-5 ml-5">Details of Services</h2>
					...
					<div className="ml-5 my-5">
						<h2 className="text-info head-title mt-5">FAQ of Our Service</h2>
