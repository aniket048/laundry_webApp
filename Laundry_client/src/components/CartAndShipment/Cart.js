...
const Cart = (props) => {
	...
	return (
		<div className="cartClass" style={{ height: cartHeight }}>
			<h4 className="text-info d-flex justify-content-center m-2">Your Bag</h4>
			...
			<List className={classes.root}>
					...
					<div key={item.id}>
						...
						<ListItem>
							...
							<Typography className={classes.secondaryHeading}>
								<span className="price"><FontAwesomeIcon icon={faRupeeSign} /> {item.price * item.quantity}</span>
							</Typography>
						</ListItem>
					</div>
				))}
				...
				<ListItem>
					...
					<ListItemText primary="" />
					<Typography className={classes.secondaryHeading}>
						<span className="price"><FontAwesomeIcon icon={faRupeeSign} /> {subTotal}</span>
					</Typography>
				</ListItem>
				<ListItem>
					...
					<ListItemText primary="" />
					<Typography className={classes.secondaryHeading}>
						<span className="price"><FontAwesomeIcon icon={faRupeeSign} /> {deliveryCharge}</span>
					</Typography>
				</ListItem>
				<ListItem>
					...
					<ListItemText primary="" />
					<Typography className={classes.secondaryHeading}>
						<span className="price"><FontAwesomeIcon icon={faRupeeSign} /> {grandTotal}</span>
					</Typography>
				</ListItem>
			</List>
			...
			{totalQuantity ? props.success ? (
				<div className="">
					...
					<div className="d-flex justify-content-center">
						<Link to="/dashboard">
							<Button className="nav-name my-4" color="info" onClick={handleFinalOrder}>
				...
				<div className="d-flex justify-content-center">
					<Link to="/cart-and-shipment">
						<Button className="nav-name my-4" color="info">
